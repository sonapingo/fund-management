                ...
                <el-col :span="24">
                    <div class="pagination">
                        <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
                            ...
                            :page-size="paginations.page_size" layout="total, sizes, prev, pager, next, jumper"
...
export default {
    ...
    methods: {
        getProfile() {
            this.$axios.get('/api/profiles')
                .then(res => {
                    ...
                    this.filiterTableData=res.data
                    this.setPaginations()
                })
        ...
        handleSearch(){
            ...
            this.allTableData=this.filiterTableData.filter(item => {
